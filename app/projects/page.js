    ...
    <>
      <div className='bg-slate-50'>
        ...
        <header className='flex flex-col items-center py-3 gap-4 md:mx-96 px-28 sm:mx-auto'>
          ...
          <p className='dark:text-gray-500 font-semibold text-center'>A project is a single or team activity, combining research and design with best effort. Here are some of our teams projects</p>
        </header>
